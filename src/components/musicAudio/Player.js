...
// import { AiFillCaretLeft, AiFillCaretRight, AiFillPlayCircle, AiFillPauseCircle  } from 'react-icons';
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faAngleLeft, faAngleRight, faPlay, faPause } from "@fortawesome/free-solid-svg-icons";
import styled from "styled-components";

import { useSelector, useDispatch } from "react-redux";
import { setCurrentSong, setIsPlaying, setSongInfo, setSongs } from "../../state/musicSlice";
...
const Player = ({ audioRef }) => {
	...
	const {isPlaying, songInfo, songs, currentSong} = useSelector((state) => state.music);
